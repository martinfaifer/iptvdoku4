    ...
    <x-share.cards.base-card title="">
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-6 sm:col-span-3">
                <x-button class="btn btn-sm btn-doku-primary mt-2 md:absolute right-5 md:right-10"
        ...
        <x-form wire:submit="create">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12">
                    <x-choices-offline label="Poskytovatel" wire:model="form.nangu_isp_id" :options="$nanguIsps" searchable
                        single />
                </div>
                <div class="col-span-12">
            ...
            <div class="flex justify-between">
                <div>
                    <x-button label="Zavřít" class="btn btn-primary-close w-full sm:w-28" wire:click='closeDialog' />
                </div>
                <div>
