<div>
    <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-12 md:col-span-6">
            <livewire:settings.genius-tv.statistics.settings-genius-tv-statistics-for-all-channels-component lazy></livewire:settings.genius-tv.statistics.settings-genius-tv-statistics-for-all-channels-component>
        </div>
