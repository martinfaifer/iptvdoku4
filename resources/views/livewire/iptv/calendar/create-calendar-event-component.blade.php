<div>
    ...
    {{-- create modal --}}
    <x-drawer wire:model.live="storeModal"  right class="lg:w-2/3 !bg-[#0E1E33]">
        <x-form wire:submit="create">
            ...
            <div class="overflow-y-auto">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-12 md:col-span-6 mb-4">
                        <x-choices-offline label="Barva" wire:model.live="form.color" :options="$cssColors" option-label="color"
                            single searchable>
                            @scope('item', $cssColor)
                    ...
                    <div class="col-span-12 md:col-span-6 mb-4">
                        <x-file label="Zde můžete nahrát banner" wire:model.live="form.banner" accept="image/png" />
                    </div>
