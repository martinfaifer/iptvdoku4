        ...
        @else
            ...
            <div class="grid grid-cols-12 mt-8">
                <div class="col-span-12 flex">
                    ...
                    {{-- actions --}}
                    <livewire:iptv.cards.update-satelit-card-component :satelitCard="$satelitCard" lazy />

                    <livewire:iptv.cards.delete-satelit-card-component :satelitCard="$satelitCard" lazy />
                    {{-- end of actions --}}
                </div>
            </div>
            <hr
                class="w-full h-[1px] h-1 mt-2 mx-auto my-1 bg-slate-800/5 dark:bg-gradient-to-r dark:from-sky-950 dark:via-blue-850 dark:to-sky-950 border-0 rounded">
            <div class="mt-4">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    {{-- expirations --}}
                    <div class="col-span-12 md:col-span-12 xl:col-span-6">
                        <livewire:iptv.cards.expiration-component :satelitCard="$satelitCard" lazy />
                    </div>
                </div>
