...
{
    public function get_charts(string $item, bool $useDisctinct = false, string $chartType = 'line'): array
    {
        $charts = [];
        // select unique items
    ...
    public function createAxis(mixed $chartsData, string $chartType = 'line'): array
    {
        $labels = [];
        $data = [];
